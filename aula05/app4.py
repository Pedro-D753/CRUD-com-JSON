...
while True:
    try:
        ...
        with open(fr'C:\Users\PedroDomiensedosSant\Documents\LogicaProgramaca_oAulas\aula05/{nome_arquivo}.txt', 'w', encoding= 'utf-8') as f:
            f.write(novo_texto)
        ...
        novo_texto_adicional = input('Digite o novo texto: \n') 

        with open(fr'C:\Users\PedroDomiensedosSant\Documents\LogicaProgramaca_oAulas\aula05/{nome_arquivo}.txt', 'a', encoding= 'utf-8') as f:
             f.write(f'\n{novo_texto_adicional}')
